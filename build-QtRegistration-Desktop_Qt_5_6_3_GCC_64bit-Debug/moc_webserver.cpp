...
#include "../QtRegistration/webserver.h"
...
QT_MOC_LITERAL(1, 10, 17), // "anErrorHasOccured"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "WebServer\0anErrorHasOccured\0"
};
...
void WebServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->anErrorHasOccured((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (WebServer::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WebServer::anErrorHasOccured)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject WebServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_WebServer.data,
...
// SIGNAL 0
void WebServer::anErrorHasOccured(QString _t1)
{
