...
public:
    ...
    {
        AllUsers->setWindowTitle(QApplication::translate("AllUsers", "All Users", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("AllUsers", "Delete", Q_NULLPTR));
        pushButton->setText(QApplication::translate("AllUsers", "Close", Q_NULLPTR));
    } // retranslateUi
