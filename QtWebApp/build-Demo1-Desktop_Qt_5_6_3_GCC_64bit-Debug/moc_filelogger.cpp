...
struct qt_meta_stringdata_stefanfrings__FileLogger_t {
    QByteArrayData data[1];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_stefanfrings__FileLogger_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_stefanfrings__FileLogger_t qt_meta_stringdata_stefanfrings__FileLogger = {
    {
QT_MOC_LITERAL(0, 0, 24) // "stefanfrings::FileLogger"

    },
    "stefanfrings::FileLogger"
};
...
const QMetaObject stefanfrings::FileLogger::staticMetaObject = {
    { &Logger::staticMetaObject, qt_meta_stringdata_stefanfrings__FileLogger.data,
      qt_meta_data_stefanfrings__FileLogger,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *stefanfrings::FileLogger::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_stefanfrings__FileLogger.stringdata0))
